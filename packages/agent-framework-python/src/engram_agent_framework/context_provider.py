"""Engram context provider for Microsoft Agent Framework.
...
class EngramContextProvider(BaseContextProvider):
    """Context provider that integrates Engram into the agent pipeline.
    ...
    def __init__(
        ...
        *,
        ...
        context_prompt: str = "",
        verbose: bool = False,
        source_id: str = "engram",
    ) -> None:
        """Initialize the Engram context provider.

        Args:
            connection: Shared AgentEngram connection.
    ...
    async def before_run(
        ...
        *,
        ...
        """Search Engram for relevant memories and inject into context."""
    ...
    async def after_run(
        ...
        *,
        ...
        """Store conversation messages to Engram for future retrieval."""
        ...
        try:
            ...
            self._logger.info(
                "Storing conversation to Engram",
                {
                    "container_tag": self._container_tag,
    ...
    async def _fetch_memories(self, query_text: str = "") -> str:
        """Fetch and format memories from Engram."""
