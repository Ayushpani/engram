#!/usr/bin/env python3
"""
Integration test for Engram OpenAI middleware.
...
async def test_async_middleware():
    ...
    try:
        ...
        if not os.getenv("ENGRAM_API_KEY"):
            print("❌ ENGRAM_API_KEY not set - skipping Engram test")
            return
...
def test_error_handling():
    ...
    try:
        ...
        # This should raise EngramConfigurationError
        with_engram(openai_client, OpenAIMiddlewareOptions(container_tag="test-user", custom_id="test-conv"))

        print("❌ Should have raised EngramConfigurationError")
...
def test_background_tasks():
    ...
    try:
        if not os.getenv("ENGRAM_API_KEY"):
            print("❌ ENGRAM_API_KEY not set - skipping background task test")
            return
...
async def main():
    """Run all tests."""
    print("🧪 Engram OpenAI Middleware Integration Tests")
    print("=" * 60)
    ...
    print("   export ENGRAM_API_KEY='your-engram-key'")
