---
title: "Introduction"
description: "engram is the Memory API for the AI era"
mode: "custom"
---
...
<div className="relative pb-12">
  ...
  <div className="px-4 py-16 lg:py-32 max-w-4xl mx-auto">
    <h1 className="text-5xl font-bold text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      engram <span className="text-primary font-medium">[docs]</span>
    </h1>
    ...
    <div className="mt-16 lg:mt-20 grid sm:grid-cols-2 gap-8">
      ...
      <HeroCard
        ...
        title="User profiles"
        description="One line to add memory to your app. Supercharge your LLM with engram's intelligent context management."
      ...
      <HeroCard
        ...
        title="SDKs"
        description="Use engram with your favorite tools and platforms seamlessly."
        href="/integrations/engram-sdk"
      />

      <HeroCard
        imageUrl="https://imagedelivery.net/_Zs8NCbSWCQ8-iurXrWjBg/eda8b2fd-9633-4e93-c6bd-10b44be75e00/public"
        title="Cookbooks"
        description="Get started with engram with tutorials and examples"
