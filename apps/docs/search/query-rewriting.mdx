...
Query rewriting automatically generates multiple variations of your search query to improve result coverage and accuracy. Smaran creates several rewrites, searches through all of them, then merges and deduplicates the results.

## How Query Rewriting Works

When you enable `rewriteQuery: true`, Smaran:
