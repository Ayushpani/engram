...
<Tip>
**Using Vercel AI SDK?** Check out our [AI SDK integration](/integrations/ai-sdk) for the cleanest implementation with `@smaran/tools/ai-sdk` - it's our recommended approach for new projects.
</Tip>
