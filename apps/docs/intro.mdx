---
title: "Overview — What is Smaran?"
sidebarTitle: "Overview"
icon: "book-open"
---

Smaran is the long-term and short-term memory and context infrastructure for AI agents. It is the [state of the art](https://smaran.ai/research) across multiple different benchmarks, like LongMemEval and LoCoMo.

With smaran, developers can provide perfect recall about their users to build AI agents that are more intelligent, more personalized, and more consistent. Additionally, *smaran* has all the pieces of the context stack built in:
...
All this, coming together, makes smaran the best abstraction to provide to agents.

## How does it work? (at a glance)

![](/images/232.png)

- You send Smaran text, files, and chats.
- Smaran [intelligently indexes them](/concepts/how-it-works) and builds a semantic understanding graph on top of an entity (e.g., a user, a document, a project, an organization).
- At query time, we fetch only the most relevant context and pass it to your models.

## Smaran is context engineering.

#### Ingestion and Extraction

Smaran handles all the extraction, for [any data type that you have](/concepts/content-types).
- Text
- Conversations
...
Smaran learns and builds the memory for the user. These are extracted facts about the user, that:
...
Developers can configure smaran with what static and dynamic contents are, depending on their use case.
