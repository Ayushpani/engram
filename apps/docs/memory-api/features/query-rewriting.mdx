...
description: "Query Rewriting in smaran"
icon: "blend"
---
...
In smaran, you can enable query rewriting by setting the `rewriteQuery` parameter to `true` in the search API.
...
- smaran generates multiple rewrites, and runs the search through all of them.
