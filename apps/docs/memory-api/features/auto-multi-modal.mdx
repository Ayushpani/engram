...
description: "engram automatically detects the content type of the document you are adding."
icon: "sparkles"
---

engram is natively multi-modal, and can automatically detect the content type of the document you are adding.

We use the best of breed tools to extract content from URLs, and process it for optimal memory storage.

## Automatic Content Type Detection

engram automatically detects the content type of the document you're adding. Simply pass your content to the API, and engram will handle the rest.
...
<Note>
  engram uses [Markdowner](https://md.dhr.wtf) to extract content from
  URLs.
</Note>

## Supported Content Types

engram supports a wide range of content formats to ensure versatility in memory creation:
...
<Steps>
  <Step title="Content Detection">
    engram automatically identifies the content type based on the input provided.
  </Step>
