...
description: 'Sync external connections like Google Drive, Notion, OneDrive, Web Crawler with smaran'
---

smaran can sync external connections like Google Drive, Notion, OneDrive, and Web Crawler.

### The Flow

For OAuth-based connectors (Notion, Google Drive, OneDrive):
1. Make a `POST` request to `/v3/connections/{provider}`
2. smaran will return an `authLink` which you can redirect the user to
