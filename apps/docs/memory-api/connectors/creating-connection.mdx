...
description: 'Create a connection to sync your content with engram'
---
...
url = "https://api.engram.ai/v3/connections/{provider}"
...
engram sends a response with the following schema:
```json
{
  "id": "<string>",
  "authLink": "<string>",
