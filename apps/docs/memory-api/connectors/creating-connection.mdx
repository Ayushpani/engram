...
description: 'Create a connection to sync your content with smaran'
---
...
url = "https://api.smaran.ai/v3/connections/{provider}"
...
smaran sends a response with the following schema:
```json
{
  "id": "<string>",
  "authLink": "<string>",
