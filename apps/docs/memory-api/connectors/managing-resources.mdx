...
const response = await fetch(
  `https://api.engram.ai/v3/connections/${connectionId}/resources?page=1&per_page=30`,
  {
    headers: {
...
url = f"https://api.engram.ai/v3/connections/{connection_id}/resources"
params = {
    "page": 1,
    "per_page": 30
}
...
// Configure connection
const response = await fetch(
  `https://api.engram.ai/v3/connections/${connectionId}/configure`,
  {
    method: 'POST',
    headers: {
      'Authorization': `Bearer ${process.env.ENGRAM_API_KEY}`,
...
url = f"https://api.engram.ai/v3/connections/{connection_id}/configure"
headers = {
    "Authorization": f"Bearer {api_key}",
    "Content-Type": "application/json",
}
...
const resourcesResponse = await fetch(
  `https://api.engram.ai/v3/connections/${connection.id}/resources?page=1&per_page=100`,
  {
    headers: {
      'Authorization': `Bearer ${process.env.ENGRAM_API_KEY}`,
    },
...
const configureResponse = await fetch(
  `https://api.engram.ai/v3/connections/${connection.id}/configure`,
  {
    method: 'POST',
    headers: {
      'Authorization': `Bearer ${process.env.ENGRAM_API_KEY}`,
...
resources_response = requests.get(
    f"https://api.engram.ai/v3/connections/{connection.id}/resources",
...
configure_response = requests.post(
    f"https://api.engram.ai/v3/connections/{connection.id}/configure",
...
curl -X GET \
  "https://api.engram.ai/v3/connections/{connectionId}/resources?page=1&per_page=100" \
