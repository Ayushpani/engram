---
title: 'Google Drive'
description: 'Sync your Google Drive content with smaran'
---

smaran syncs Google Drive documents automatically and instantaneously.
...
To import items, smaran converts documents into markdown, and then ingests them into smaran.
