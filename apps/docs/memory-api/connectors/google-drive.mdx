---
title: 'Google Drive'
description: 'Sync your Google Drive content with engram'
---

engram syncs Google Drive documents automatically and instantaneously.
...
To import items, engram converts documents into markdown, and then ingests them into engram.
