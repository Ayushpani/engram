...
description: "Learn how to integrate smaran into your application"
---

## Authentication

Head to [smaran's Developer Platform](https://console.smaran.ai) built to help you monitor and manage every aspect of the API.
...
You can use smaran through the APIs, or using our SDKs

<CodeGroup>

```bash cURL
https://api.smaran.ai/v3
```
...
This will add a new memory to your smaran account.
...
<Accordion title="Processing steps" icon="sparkles">
  When you add content to smaran, it goes through several processing steps:
...
```bash cURL
curl https://api.smaran.ai/v3/search \
  --request POST \
  --header 'Content-Type: application/json' \
  --header 'Authorization: Bearer SMARAN_API_KEY' \
...
You can do a lot more with smaran, and we will walk through everything you need to.

Next, explore the features available in smaran
