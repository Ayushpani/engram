---
title: Quickstart
description: Make your first API call to Engram - add and retrieve memories.
icon: "play"
---

<Tip>
**Using Vercel AI SDK?** Check out the [AI SDK integration](/integrations/ai-sdk) for the cleanest implementation with `@engram/tools/ai-sdk`.
</Tip>

## Memory API

**Step 1.** Sign up for [Engram's Developer Platform](http://console.engram.ai) to get the API key. Click on **API Keys -> Create API Key** to generate one.
...
```bash
pip install engram
export ENGRAM_API_KEY="YOUR_API_KEY"
```
</Tab>
...
That's it! Engram automatically:
