---
title: Quickstart
description: Make your first API call to Smaran - add and retrieve memories.
icon: "play"
---

<Tip>
**Using Vercel AI SDK?** Check out the [AI SDK integration](/integrations/ai-sdk) for the cleanest implementation with `@smaranai/tools/ai-sdk`.
</Tip>

## Memory API

**Step 1.** Sign up for [Smaran's Developer Platform](http://console.smaran.ai) to get the API key. Click on **API Keys -> Create API Key** to generate one.
...
```bash
pip install smaran
export SMARAN_API_KEY="YOUR_API_KEY"
```
</Tab>
...
That's it! Smaran automatically:
