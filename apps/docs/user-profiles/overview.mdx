...
User profiles are **automatically maintained collections of facts about your users** that Engram builds from all their interactions and content. Think of it as a persistent "about me" document that's always up-to-date and instantly accessible.
...
Profiles are **automatically built and maintained** through Engram's ingestion pipeline:

<Steps>
  <Step title="Content Ingestion">
    When users add documents, chat, or any content to Engram, it goes through the standard ingestion workflow.
  </Step>
