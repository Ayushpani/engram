...
<Card title="@smaran/tools on npm" icon="npm" href="https://www.npmjs.com/package/@smaran/tools">
...
```bash
npm install @smaran/tools @mastra/core
```
...
import { Agent } from "@mastra/core/agent"
import { withSmaran } from "@smaran/tools/mastra"
import type { MemoryPromptData } from "@smaran/tools/mastra"
