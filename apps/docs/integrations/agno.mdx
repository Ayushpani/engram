...
title: "Agno"
sidebarTitle: "Agno"
description: "Add persistent memory to Agno agents with Engram"
icon: "brain"
---

Agno agents are stateless by default. Each conversation starts fresh. Engram changes that - your agents can remember users, recall past conversations, and build on previous interactions.
...
```bash
pip install agno engram python-dotenv
```
