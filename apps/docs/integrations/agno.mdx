...
title: "Agno"
sidebarTitle: "Agno"
description: "Add persistent memory to Agno agents with Smaran"
icon: "brain"
---

Agno agents are stateless by default. Each conversation starts fresh. Smaran changes that - your agents can remember users, recall past conversations, and build on previous interactions.
...
```bash
pip install agno smaran python-dotenv
```
