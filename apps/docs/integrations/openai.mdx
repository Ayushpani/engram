...
```bash
npm install @smaran/tools openai
```
...
import { smaranTools } from "@smaran/tools/openai"
...
import OpenAI from "openai"
import { getToolDefinitions, createToolCallExecutor } from "@smaran/tools/openai"
...
import OpenAI from "openai"
import { getToolDefinitions } from "@smaran/tools/openai"
