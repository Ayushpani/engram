...
description: "Build AI agents with persistent memory using LangChain and Engram"
icon: "link"
---

Build AI applications with LangChain that remember context across conversations. Engram handles memory storage, retrieval, and user profiling while LangChain manages your conversation flow.

## Overview

This guide shows how to integrate Engram with LangChain to create AI agents that:
...
```bash
pip install langchain langchain-openai engram python-dotenv
```
...
Engram automatically maintains user profiles with two types of information:
