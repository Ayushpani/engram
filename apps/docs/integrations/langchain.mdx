...
description: "Build AI agents with persistent memory using LangChain and Smaran"
icon: "link"
---

Build AI applications with LangChain that remember context across conversations. Smaran handles memory storage, retrieval, and user profiling while LangChain manages your conversation flow.

## Overview

This guide shows how to integrate Smaran with LangChain to create AI agents that:
...
```bash
pip install langchain langchain-openai smaran python-dotenv
```
...
Smaran automatically maintains user profiles with two types of information:
