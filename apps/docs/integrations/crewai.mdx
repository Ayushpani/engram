...
title: "CrewAI"
sidebarTitle: "CrewAI"
description: "Add persistent memory to CrewAI agents with Engram"
icon: "users"
---

CrewAI agents don't remember anything between runs by default. Engram fixes that. You get a memory layer that stores what happened, who the user is, and what they care about. Your crews can pick up where they left off.
...
```bash
pip install crewai engram python-dotenv
```
...
Initialize Engram and inject user context into your agent's backstory:
...
Engram tracks two kinds of user data:
