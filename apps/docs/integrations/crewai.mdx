...
title: "CrewAI"
sidebarTitle: "CrewAI"
description: "Add persistent memory to CrewAI agents with Smaran"
icon: "users"
---

CrewAI agents don't remember anything between runs by default. Smaran fixes that. You get a memory layer that stores what happened, who the user is, and what they care about. Your crews can pick up where they left off.
...
```bash
pip install crewai smaran python-dotenv
```
...
Initialize Smaran and inject user context into your agent's backstory:
...
Smaran tracks two kinds of user data:
