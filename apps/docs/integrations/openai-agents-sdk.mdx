...
description: "Add persistent memory to OpenAI agents with Smaran"
icon: "/images/openai.svg"
---

OpenAI's Agents SDK gives you a straightforward way to build agents with tools, handoffs, and guardrails. But agents don't remember users between sessions. Smaran adds that missing piece: your agents can store what they learn and recall it later.
...
```bash
pip install openai-agents smaran python-dotenv
```
...
Smaran keeps two buckets of user info:
