...
description: "Add persistent memory to OpenAI agents with Engram"
icon: "/images/openai.svg"
---

OpenAI's Agents SDK gives you a straightforward way to build agents with tools, handoffs, and guardrails. But agents don't remember users between sessions. Engram adds that missing piece: your agents can store what they learn and recall it later.
...
```bash
pip install openai-agents engram python-dotenv
```
...
Engram keeps two buckets of user info:
