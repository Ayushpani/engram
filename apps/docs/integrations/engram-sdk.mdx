---
title: 'Engram SDK'
sidebarTitle: "Engram SDK"
description: 'Official Python and JavaScript SDKs for Engram'
icon: "/images/engram.svg"
---
...
<Tabs>
  <Tab title="TypeScript">
    ...
    const client = new Engram({
      apiKey: process.env.ENGRAM_API_KEY,  // Default, can be omitted
    });
  ...
  <Tab title="Python">
    ...
    client = Engram(
        api_key=os.environ.get("ENGRAM_API_KEY"),  # Default, can be omitted
    )
