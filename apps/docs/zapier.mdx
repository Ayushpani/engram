---
title: "Integrate smaran in your Zapier workflows"
sidebarTitle: "Zapier"
description: "Learn how to use the code block to integrate smaran with  Zapier and add memory to your automations."
---

With Smaran you can now easily add memory to your Zapier workflow steps. Here's how:

## Prerequisites
- A Smaran API Key. Get yours [here](https://console.smaran.ai)

## Step-by-step tutorial

For this tutorial, we're building a simple flow that adds incoming emails in Gmail to Smaran.
...
<Steps>
    ...
    <Step title="Integrate Smaran">
        ...
        ```python 
            ...
            url = "https://api.smaran.ai/v3/documents"
...
You can perform other operations like search, filtering, user profiles, etc., by using other Smaran API endpoints which can be found in our API Reference tab.