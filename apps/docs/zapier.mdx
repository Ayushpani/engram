---
title: "Integrate engram in your Zapier workflows"
sidebarTitle: "Zapier"
description: "Learn how to use the code block to integrate engram with  Zapier and add memory to your automations."
---
