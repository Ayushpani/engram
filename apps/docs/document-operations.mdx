...
<Tabs>
  ...
  <Tab title="cURL">
    ```bash
    curl "https://api.engram.ai/v3/documents/doc_abc123" \
      -H "Authorization: Bearer $ENGRAM_API_KEY"
    ```
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="cURL">
    ```bash
    curl -X PATCH "https://api.engram.ai/v3/documents/doc_abc123" \
      -H "Authorization: Bearer $ENGRAM_API_KEY" \
      -H "Content-Type: application/json" \
...
<Tabs>
  ...
  <Tab title="cURL">
    ```bash
    # Single delete
    curl -X DELETE "https://api.engram.ai/v3/documents/doc_abc123" \
      -H "Authorization: Bearer $ENGRAM_API_KEY"
...
<Tabs>
  ...
  <Tab title="cURL">
    ```bash
    curl "https://api.engram.ai/v3/documents/processing" \
      -H "Authorization: Bearer $ENGRAM_API_KEY"
    ```
  </Tab>
</Tabs>
