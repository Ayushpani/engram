...
User profiles are **automatically maintained collections of facts about your users** that Engram builds from all their interactions. Think of it as a persistent "about me" document that's always up-to-date.
