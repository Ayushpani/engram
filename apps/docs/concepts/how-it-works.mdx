---
title: "How Engram Works"
description: "Understanding the knowledge graph architecture that powers intelligent memory"
icon: "cpu"
---


Engram isn't just another document storage system. It's designed to mirror how human memory actually works - forming connections, evolving over time, and generating insights from accumulated knowledge.

![](/images/graph-view.png)

## The Mental Model

Traditional systems store files. Engram creates a living knowledge graph.
...
<CardGroup cols={2}>
  ...
  <Card title="Engram" icon="network">
...
Understanding this distinction is crucial to using Engram effectively.
...
Think of documents as books you hand to Engram. See [Content Types](/concepts/content-types) for the full list of supported formats.

### Memories: Intelligent Knowledge Units

Memories are what Engram creates - the understanding:
...
<Note>
**Key Insight**: When you upload a 50-page PDF, Engram doesn't just store it. It breaks it into hundreds of interconnected memories, each understanding its context and relationships to your other knowledge.
</Note>
...
When new information contradicts or updates existing knowledge, Engram creates an "update" relationship.

<CodeGroup>
```text Original Memory
"You work at Engram as a content engineer"
```

```text New Memory (Updates Original)
"You now work at Engram as the CMO"
```
</CodeGroup>
...
When new information adds to existing knowledge without replacing it, Engram creates an "extends" relationship.

Continuing our "working at engram" analogy, a memory about what you work on would extend the memory about your role given above.

<CodeGroup>
```text Original Memory
"You work at Engram as the CMO"
```
...
The most sophisticated relationship - when Engram infers new connections from patterns in your knowledge.

<CodeGroup>
```text Memory 1
"Dhravya is the founder of Engram"
```
...
```text Derived Memory
"Engram is likely an AI-focused company"
```
</CodeGroup>
...
Now that you understand how Engram works:
