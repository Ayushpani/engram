---
title: "File Upload"
description: "Upload PDFs, images, and other files to Engram"
---

Upload files directly to Engram for automatic content extraction and processing.
...
function handleUpload(file: File) {
  ...
  return fetch('https://api.engram.ai/v3/documents/file', {
    method: 'POST',
