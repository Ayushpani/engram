---
title: "File Upload"
description: "Upload PDFs, images, and other files to Smaran"
---

Upload files directly to Smaran for automatic content extraction and processing.
...
function handleUpload(file: File) {
  ...
  return fetch('https://api.smaran.ai/v3/documents/file', {
    method: 'POST',
