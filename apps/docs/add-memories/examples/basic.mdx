---
title: "Basic Usage"
description: "Simple examples of adding text content to Smaran"
---

Learn how to add basic text content to Smaran with simple, practical examples.
...
Smaran preserves markdown formatting.
