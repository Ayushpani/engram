---
title: 'Self Hosting'
description: 'Deploy your own instance of the smaran API on Cloudflare Workers'
---

<Warning>
This guide is intended for **enterprise customers only** who have specifically opted for self-hosting as part of their enterprise plan. If you're on a standard plan, please use our hosted API at [console.smaran.ai](https://console.smaran.ai).
</Warning>
...
Your enterprise deployment package is provided by the smaran team and contains:
- Your unique Host ID (`NEXT_PUBLIC_HOST_ID`)
- The compiled JavaScript bundle
- The deployment script

Contact your smaran enterprise representative to receive your deployment package.
...
5. Name your key (e.g., "smaran Self-Hosted")
...
4. Name your key (e.g., "smaran Production")
...
Extract the deployment package provided by the smaran team to your preferred directory:

```bash
# Extract the deployment package
$ unzip smaran-enterprise-deployment.zip
$ cd smaran-deployment
```
...
| `NEXT_PUBLIC_HOST_ID` | ✅ | Your unique Host ID provided by the smaran team. |
...
To update your smaran deployment, follow the same process as the initial deployment described in the **Deploy** section above. You can reuse your existing `.env` file and add/remove any new environment variables as needed.
