...
Complete rewrite of `@smaran/memory-graph` with improved visualization and performance.

</Update>

<Update label="December 24, 2025" tags={["SDK"]}>

### `@smaran/tools` — AI SDK v5/v6
...
### `@smaran/tools` — Browser API Key Support
...
### `@smaran/tools` — AI SDK `withSmaran`
