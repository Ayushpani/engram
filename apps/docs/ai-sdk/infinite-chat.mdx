...
const infiniteChat = createAnthropic({
  baseUrl: 'https://api.engram.ai/v3/https://api.anthropic.com/v1',
...
const infiniteChat = createGoogleGenerativeAI({
  baseUrl: 'https://api.engram.ai/v3/https://generativelanguage.googleapis.com/v1beta',
  apiKey: 'your-provider-api-key',
  headers: {
    'x-engram-api-key': 'engram-api-key',
    'x-sm-conversation-id': 'conversation-id'
...
const infiniteChat = createGroq({
  baseUrl: 'https://api.engram.ai/v3/https://api.groq.com/v1',
  apiKey: 'your-provider-api-key',
  headers: {
    'x-engram-api-key': 'engram-api-key',
    'x-sm-conversation-id': 'conversation-id'
