...
```bash
git clone https://github.com/smaranai/memorybench
cd memorybench
bun install
```
...
<Note>
You only need API keys for the providers and judges you plan to use. For example, to benchmark Smaran with GPT-4o as judge, you only need `SMARAN_API_KEY` and `OPENAI_API_KEY`.
</Note>
