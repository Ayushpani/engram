...
```bash
git clone https://github.com/engramai/memorybench
cd memorybench
bun install
```
...
<Note>
You only need API keys for the providers and judges you plan to use. For example, to benchmark Engram with GPT-4o as judge, you only need `ENGRAM_API_KEY` and `OPENAI_API_KEY`.
</Note>
