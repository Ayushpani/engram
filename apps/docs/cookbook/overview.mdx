---
title: "Cookbook"
description: "Complete examples and recipes for building with Engram"
sidebarTitle: "Overview"
---

The Engram Cookbook provides complete, production-ready examples that show how to build real applications with Engram. Each recipe includes full implementation details, best practices, and common patterns.
...
<CardGroup cols={2}>
  ...
  <Card title="AI SDK Integration" icon="triangle" href="/cookbook/ai-sdk-integration">
    Complete examples using Vercel AI SDK with Engram tools
  </Card>
</CardGroup>

## Coming Soon

We're working on more comprehensive recipes. Have a suggestion? [Let us know!](mailto:support@engram.ai)
...
- Reach out to [support](mailto:support@engram.ai) for help

## Contributing Recipes

Have a great Engram use case? We'd love to add it to the cookbook!

[Suggest a recipe →](mailto:support@engram.ai?subject=Cookbook%20Recipe%20Suggestion)
