---
title: "Cookbook"
description: "Complete examples and recipes for building with Smaran"
sidebarTitle: "Overview"
---

The Smaran Cookbook provides complete, production-ready examples that show how to build real applications with Smaran. Each recipe includes full implementation details, best practices, and common patterns.
...
<CardGroup cols={2}>
  ...
  <Card title="AI SDK Integration" icon="triangle" href="/cookbook/ai-sdk-integration">
    Complete examples using Vercel AI SDK with Smaran tools
  </Card>
</CardGroup>

## Coming Soon

We're working on more comprehensive recipes. Have a suggestion? [Let us know!](mailto:support@smaran.ai)
...
- Reach out to [support](mailto:support@smaran.ai) for help

## Contributing Recipes

Have a great Smaran use case? We'd love to add it to the cookbook!

[Suggest a recipe →](mailto:support@smaran.ai?subject=Cookbook%20Recipe%20Suggestion)
