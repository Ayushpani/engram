...
<CardGroup cols={2}>
  <Card
    ...
    href="https://github.com/engramai/examples/tree/main/research-assistant"
  >
    Upload documents and chat with an AI that can search and cite them.
    Next.js + TypeScript + `@engram/bash`.
  </Card>
  <Card
    title="Knowledge Base"
    icon="book"
    href="https://github.com/engramai/examples/tree/main/knowledge-base"
  >
    Add notes and chat with an AI that can search your knowledge base.
    FastAPI + Python + `engram-bash`.
  </Card>
  <Card
    title="Code Sandbox"
    icon="terminal"
    href="https://github.com/engramai/examples/tree/main/code-sandbox"
  >
...
Engram-backed filesystem. The Code Sandbox example uses an
[E2B](/smfs/providers/e2b) sandbox with a real SMFS mount.

## Running an example

1. Clone the [examples repo](https://github.com/engramai/examples)
