...
description: 'Technical implementation details of smaran MCP'
---

The technical architecture prioritizes **simplicity and user experience** while maintaining robust functionality. Built as what the creators describe as "the simplest thing you'll see" - essentially a React Router application making fetch calls to the smaran API - the entire system was developed and shipped in approximately 5 hours of actual work time.

### Architecture components

- **Backend API**: Built on top of the smaran API (https://api.smaran.ai/v3)
