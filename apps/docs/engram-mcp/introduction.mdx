---
title: 'About Smaran MCP'
description: 'Give your AI assistants persistent memory with the Model Context Protocol'
---

Smaran MCP Server 4.0 is a lightweight component that gives AI assistants persistent memory across conversations. It serves as a universal memory layer enabling Large Language Models (LLMs) to maintain context and memories across different applications and sessions, solving the fundamental limitation of AI assistants forgetting everything between conversations.

<Card title="Quick Start" icon="rocket" href="/smaran-mcp/mcp">
  Jump to installation and setup
</Card>

## What Smaran MCP Does

**Smaran MCP** functions as a universal memory system that bridges AI applications through the [Model Context Protocol (MCP)](https://modelcontextprotocol.io). It operates as an **MCP server** that communicates with MCP-compatible clients, storing and retrieving contextual information through the Smaran API infrastructure.
...
- **OAuth Authentication** - Secure login through Smaran accounts
...
2. The client connects to `https://mcp.smaran.ai/mcp`
...
- **OAuth by default** - Secure authentication through Smaran accounts
...
<Card title="Source Code" icon="github" href="https://github.com/smaranai/smaran/tree/main/apps/mcp">
