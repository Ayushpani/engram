...
const TIPS: Record<Profession, string[]> = {
	developer: [
		...
		"Drop in your last 3 PRs and ask Smaran for the review patterns",
	...
	research: [
		...
		"Save a paper once — Smaran finds it later by what it argued",
	...
	design: [
		...
		"Drop in 10 onboarding flows and ask Smaran for the common patterns",
	...
	medical: [
		...
		"Drop in three trials and ask Smaran for the methodological diffs",
	...
	default: [
		...
		"Save an idea — Smaran connects it to your earlier ones",
