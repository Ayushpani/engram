...
const TIPS: Record<Profession, string[]> = {
	developer: [
		...
		"Drop in your last 3 PRs and ask Engram for the review patterns",
	...
	research: [
		...
		"Save a paper once — Engram finds it later by what it argued",
	...
	design: [
		...
		"Drop in 10 onboarding flows and ask Engram for the common patterns",
	...
	medical: [
		...
		"Drop in three trials and ask Engram for the methodological diffs",
	...
	default: [
		...
		"Save an idea — Engram connects it to your earlier ones",
