...
export const SIDEBAR: SidebarSection[] = [
	...
	},
	{
		...
		items: [
			...
			{ slug: "docs/api", title: "REST API" },
		],
	},
	{
		section: "Integrations",
		items: [
			{ slug: "docs/mcp", title: "MCP server" },
			{ slug: "docs/skill", title: "Claude Skill" },
			{ slug: "docs/adapters/vapi", title: "Vapi" },
			{ slug: "docs/adapters/livekit", title: "LiveKit" },
			{ slug: "docs/adapters/pipecat", title: "Pipecat" },
			{ slug: "docs/adapters/retell", title: "Retell" },
			{ slug: "docs/adapters/anthropic", title: "Anthropic" },
			{ slug: "docs/adapters/openai", title: "OpenAI / Codex" },
			{ slug: "docs/adapters/gemini", title: "Gemini" },
		],
	},
	{
		section: "Operations",
		items: [
			{ slug: "docs/self-host", title: "Self-host" },
			{ slug: "docs/dpdp", title: "DPDP & data handling" },
		],
	},
]
